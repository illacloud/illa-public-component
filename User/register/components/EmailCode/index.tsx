...
export const EmailCode: FC<EmailCodeProps> = (props) => {
  ...
  return (
    <Link
      ...
      hoverable={false}
      onClick={async () => {
        track(ILLA_MIXPANEL_EVENT_TYPE.CLICK, usage === 'signup' ? ILLA_MIXPANEL_PUBLIC_PAGE_NAME.SIGNUP :  ILLA_MIXPANEL_PUBLIC_PAGE_NAME.FORGET_PASSWORD, {element: 'send_code'})
