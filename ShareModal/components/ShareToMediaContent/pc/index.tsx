...
const ShareToMediaContentPC: FC<ShareToMediaContentProps> = (props) => {
...
ShareToMediaContentPC.displayName = "ShareToMediaContentPC"

export default ShareToMediaContentPC
